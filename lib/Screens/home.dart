...
//                     Text('See all',
//                       style: TextStyle(
//                         fontWeight: FontWeight.w600,fontSize: 19,color: Colors.grey,
//                       ),
//                     )
//                   ],
//                 ),
...
//                 (context,index){
//                   return ListTile(leading: ClipRRect(borderRadius: BorderRadius.circular(5),child: Image.asset('images/${geter()[index].image!}',height: 10,),
//                   ),
//                     title: Text(
//                       geter()[index].name!,
//                       style: TextStyle(
...
//                         Text('Welcome',
//                           style: TextStyle(
//                               fontWeight: FontWeight.w500,fontSize: 16,color: Color.fromARGB(255, 224, 223, 223)
//                           ),
//                         ),
//                         Text('Siddhant Hole',
//                           style: TextStyle(
